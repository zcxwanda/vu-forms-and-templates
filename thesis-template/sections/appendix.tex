...
\section{Supplementary Diagnostic Results}

Table~\ref{tab:profile-condition-accuracy} reports the number of correct primary classifications for each fixed clinical profile. These are descriptive results for the five profiles used in the experiment. Because each disorder is represented by one profile, the differences should not be interpreted as general differences between disorders.

\begin{table}[H]
    \centering
    \scriptsize
    \tabcap{Correct primary classifications by clinical profile and condition.}
    \label{tab:profile-condition-accuracy}
    \resizebox{\columnwidth}{!}{%
    \begin{tabular}{lrrrrr}
        \toprule
        \thead{Profile} & \thead{Baseline} & \thead{Low} & \thead{Medium} & \thead{High} & \thead{Extreme} \\
        \midrule
        Anxiety & 5/5 & 59/60 & 58/60 & 58/60 & 37/60 \\
        Bipolar disorder & 5/5 & 60/60 & 60/60 & 59/60 & 45/60 \\
        Depression & 5/5 & 60/60 & 60/60 & 59/60 & 34/60 \\
        PTSD & 5/5 & 59/60 & 60/60 & 59/60 & 24/60 \\
        Schizophrenia & 5/5 & 59/60 & 59/60 & 54/60 & 35/60 \\
        \midrule
        Total & 25/25 & 297/300 & 297/300 & 289/300 & 175/300 \\
        \bottomrule
    \end{tabular}
    }
\end{table}
