...
\begin{table*}[tb]
    ...
    \begin{tabular}{p{0.10\linewidth}p{0.18\linewidth}p{0.30\linewidth}p{0.14\linewidth}p{0.14\linewidth}}
        \toprule
        \thead{Intensity} & \thead{Target activation range} & \thead{Expression-level probabilities} & \thead{After one activation} & \thead{Additional factor after two} \\
        \midrule
