...
User simulation is also used to evaluate task-oriented dialogue systems. Interactive evaluation has been proposed because a fixed transcript cannot reflect how each system response changes the user's next turn~\cite{cheng2022interactive}. RADDLE evaluates robustness to language variation, speech errors, unseen entities, and out-of-domain utterances, and reports weaknesses in existing task-oriented dialogue systems~\cite{peng2021raddle}. The present study brings a related robustness question into questionnaire-based mental health assessment by varying how the simulated patient responds while keeping the clinical case fixed.
